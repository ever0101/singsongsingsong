...
JNIEXPORT jint JNICALL Java_JNI_TextLcd_IOCtlWriteByte( JNIEnv* env,
...
JNIEXPORT jint JNICALL Java_JNI_TextLcd_IOCtlPos( JNIEnv* env,
...
JNIEXPORT jint JNICALL Java_JNI_TextLcd_IOCtlCursor( JNIEnv* env,
					jobject thiz , jboolean bOn)
{
	initialize();
	if(bOn) {
...
JNIEXPORT jint JNICALL Java_JNI_TextLcd_IOCtlBlink( JNIEnv* env,
					jobject thiz, jboolean bOn )
{
	initialize();
	if(bOn) {
